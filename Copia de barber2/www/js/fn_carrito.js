    ...
    color: #c7aa6a;"></span>
                 ...
                 <div class="" style="position: absolute;top:1em;width: 100%;">
                        ...
                        `;
                          ...
                          <div class="col-100">
                          <p style="color: #c7aa6a;font-size: 30px;text-align: center;" class="cambiarfuente cambiarfuente2 `+estiloparrafo+`">¿Necesitas algo más?</p>
                          </div>
...
function AbrirModalMonedero() {
  ...
  var parrafo="<p class='cambiarfuente "+estiloparrafo+"' >Tienes monedero $"+monederousuario+"</p>";
