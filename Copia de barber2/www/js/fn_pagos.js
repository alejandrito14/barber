...
var html=` <div class="sheet-modal my-sheet-swipe-to-close1" style="height: 60%;background: black;">
      ...
      if (respuesta==1) {
        ...
        localStorage.setItem('idcupon',datoscupon.idcupon);
         ...
         for (var i = 0; i < mensaje.length; i++) {
          ...
          var html=`
              <p style="color: #C7AA6A;text-align:center;font-size:30px;" class="cambiarfuente" >`+codigocupon+`</p>
