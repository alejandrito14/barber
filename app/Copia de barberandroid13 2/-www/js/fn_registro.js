                 ...
                 <div class="" style="position: absolute;top:1em;width: 100%;">
                        ...
                        `;
                          ...
                          <div class="row margin-bottom " style="padding-top: 1em;margin-left: 2em;margin-right: 2em;">
                            ...
                            <div class="col-50">
                            <button style="background: white;color:black;" type="button" class="button button-fill color-theme button-large button-raised  cambiarfuente cambiarfuente2" onclick="EjecutarValidacion('`+telefono+`',`+inputleido+`,2)">Whatsap</button>
                            </div>
                          </div>
