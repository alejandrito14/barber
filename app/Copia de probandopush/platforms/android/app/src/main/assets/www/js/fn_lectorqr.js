            ...
            $.ajax({
              ...
              success: function(res){ 
                ...
                if(respuesta.validado==3){
                  var citaenproceso=res.detallecitaenproceso[0];
                  var idcitaproceso=citaenproceso.idcita;
                  localStorage.setItem('idcita',idcitaproceso);
                  var aviso="";
...
function AbrirModalAvisoCitaProceso(aviso) {
    var aviso="Tienes una cita en proceso ¿Desear terminarla?";
