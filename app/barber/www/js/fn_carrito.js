            ...
            <div class="row">
              <div class="col-70">
               ...
               <span class="material-icons-outlined">inventory_2
                </span> <p style="margin:0;">Servicio: `+respuesta[i].nombrepaquete+`
                </p>

                </div>
                <div class="icon-text-container">
                <p style="margin:0;margin-left: 35px;">$`+respuesta[i].costototal+`</p></div>
                <div class="icon-text-container">
                 <span class="material-icons-outlined">
                   ...
                   html+=` <p>
                    ...
                    <p style="margin:0;">Barbero: `+respuesta[i].usuarioespecialista+`</p>
                    </div>
                    `;
                    html+=`
                   <div class="icon-text-container" style="margin-top:10px;">
                     ...
                     <p style="margin:0;">Fecha/Hora: `+respuesta[i].fechaformato+`</p>
    ...
    padding-top: 1em;">
                      ...
                      if (respuesta[i].idcortesia>0 ) {
                         ...
                         <div class="icon-text-container">
                           ...
                           <p style="margin:0;">Cortesía: `+respuesta[i].nombrepaquetecortesia+`</p>
...
var html=` <div class="sheet-modal my-sheet-swipe-to-close1" style="height: 100%;background: black;">
    ...
    text-align: center;" class="cambiarfuente">¿Necesitas algo más?</p>
                          ...
                          <div class="row margin-bottom " style="padding-top: 1em;    margin-left: 2em;margin-right: 2em;margin-top:20px;">
                            ...
                            <div class="col-50">
                            <button style="background: white;color:black;" type="button" class="button button-fill color-theme button-large button-raised btnagregarcortesia cambiarfuente" onclick="IrAResumenpago()">No</button>
                            </div>
                          </div>
