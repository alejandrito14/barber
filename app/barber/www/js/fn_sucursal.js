...
function PintarDatosSucursal(respuesta,imagenes) {
	...
	$(".btnconoceespecialistas").attr("onclick","ObtenerListaEspecialistasSucursal("+respuesta.idsucursal+")");
	var html="";
		   											...
		   											<div class="" style="">
												   		...
												   		if (respuesta.length>0) {
												   			for (var i = 0; i <respuesta.length; i++) {
												   				...
												   				<li style="margin-top: 1em;" onclick="DetalleEspecialista(`+respuesta[i].idespecialista+`)">
																	<div class="item-content">
...
var html=` <div class="sheet-modal my-sheet-swipe-to-close1" style="height: 100%;background: white;">
    ...
    margin-left: 1em;">
             ...
             <div class="card-bx job-card col-50" style="height: 163px;" onclick="DisponibilidadFecha(`+idsucursal+`)">
             <div class="card-info disponibilidadfecha" style="text-align: center;" >
              <span class="material-icons-outlined">
                check_circle
                </span>
             ...
             <div class="card-bx job-card col-50" style="height: 163px;" onclick="DisponibilidadEspe(`+idsucursal+`)">
             <div class="card-info disponibilidadespecialista" style="text-align: center;">
              <span class="material-icons-outlined">
                check_circle
                </span>

              <h6 class="item-title">
                Consulta disponibilidad por barbero
              </h6>
              <div class="list-info">
