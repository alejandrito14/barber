    ...
    color: #c7aa6a;"></span>
                 ...
                 <div class="" style="position: absolute;top:1em;width: 100%;">
                        ...
                        `;
                          ...
                          <div class="col-100">
                          <p style="color: #c7aa6a;font-size: 30px;text-align: center;" class="cambiarfuente cambiarfuente2">¿Necesitas algo más?</p>
                          </div>
...
function AbrirModalAvisoLogin() {
   var parrafo="<p class='cambiarfuente' style='font-size:30px;line-height:1;'>Para continuar es necesario tu registro</p>";
   
      parrafo+="<p class='cambiarfuente' style='font-size:30px;line-height:1;' >¿Estas registrado?</p>"
...
function AbrirModalMonedero() {
  ...
  var parrafo="<p class='cambiarfuente' style='font-size:30px;line-height:1;'>Tienes monedero acumulado</p>";
      parrafo+="<p class='cambiarfuente' style='font-size:30px;line-height:1;' >¿Deseas utilizarlo?</p>";
   ...
   var promesa= ConsultarMonedero();
         promesa.then(r => {
           ...
           var montopago=localStorage.getItem('sumatotalapagar');
            var valor=montopago;
              if (montopago>=monederousuario) {

               valor=monederousuario;

              }
    var sumatotalapagar=localStorage.getItem('sumatotalapagar');
  var parrafo="<p class='cambiarfuente' style='font-size:30px;line-height:1;margin:0;'><span style='color:white'>Total</span></p>";
      parrafo+="<p class='cambiarfuente' style='font-size:30px;line-height:1;margin:0;'>$"+sumatotalapagar+"</p>"
      parrafo+="<p class='cambiarfuente' style='font-size:30px;line-height:1;margin:0;'><span style='color:white'>Monedero disponible</span></p>";
      parrafo+="<p class='cambiarfuente' style='font-size:30px;line-height:1;margin:0;'>$"+r.respuesta+"</p>"
      parrafo+="<p class='cambiarfuente' style='font-size:30px;line-height:1;' >¿Cuanto deseas utilizar?</p>"
...
function AbrirModalCortesia(resp,idcarrito) {
  ...
  var parrafo="<p class='cambiarfuente' style='font-size:30px;line-height:1;'>El "+servicio+" <span style='color:white;'> "+producto.nombrepaquete+"</span> te da una cortesía</p>";
      parrafo+="<p class='cambiarfuente' style='font-size:30px;line-height:1;' >¿Cuál eliges?</p>"
