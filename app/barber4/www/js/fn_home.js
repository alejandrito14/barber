					  ...
					  <div class="">
						...
						<p class="cambiarfuente `+clasecancelado+`" style="color: white;margin:0;" onclick="AbrirModalCita(`+respuesta[i].idcita+`)">`+respuesta[i].titulo+`-`+respuesta[i].descripcion+`</a></p>`;
							...
							//aqui checkin checkout
								...
								html+=`<span>check-in: `+respuesta[i].fechachekin+`</span> <span class="material-icons-outlined" style=" width: 30px;justify-content: center;font-size: 20px;color:#5ac35b;">
								...
								html+=`
									<p class="" style="display: flex;">`;
								html+=`<span>check-out: `+respuesta[i].fechachekout+`</span> <span class="material-icons-outlined" style=" width: 30px;justify-content: center;font-size: 20px;color:#5ac35b;">
										check_circle_outline
										</span>`;
								html+=`</p>`;
									}
...
var html=` <div class="sheet-modal my-sheet-swipe-to-close1" style="height: 100%;background: black;">
	 		...
	 		<svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <div class="page-content cambiarfuente" style="height: 100%;">
                ...
                <div class="card margin-bottom" style="background:black!important;">
                    ...
                    <div class="row divimgqr" style="margin-top: 10px;margin-left: 1em;margin-right: 1em;padding-top: 1em;border-top: 1px solid white;display:none">
    ...
    margin-right: 1em;margin-left: 1em;border-bottom: 1px solid;margin-bottom: 1em;
    ...
    padding-top: 1em;">
           ...
           <div class="icon-text-container" style="margin-top: 10px; margin-left: 30px;">
                            ...
                            if(respuesta.checkin==1) {
								...
								html+=`
								<p class="" style="display: flex;">
										<span>check-out:</span> <span class="material-icons-outlined" style=" width: 30px;justify-content: center;font-size: 20px;color:#5ac35b;">
										check_circle_outline
										</span>
								</p>
										`;
