          ...
          open: function (sheet) {
             var foto=localStorage.getItem("fotoimagencitacomentario");
              ...
              if (foto!='null' && foto!='') {
                ...
                $(".imglogoimagencitacomentario").attr('src',urlphp+"upload/imagencita/"+foto);
...
function ObtenerImagenescitaCliente2() {
    var idcita=localStorage.getItem('idcita');
...
function ObtenerImagenescitaComentario() {
    var idcita=localStorage.getItem('idcita');
    var iduser=localStorage.getItem('id_user');
    var tipo=localStorage.getItem('idtipousuario');
    var datos="iduser="+iduser+"&tipo="+tipo+"&idcita="+idcita;
 ...
 if (resultado.length>0) {
  for (var i = 0; i < resultado.length; i++) {
   ...
   <div class="tarjeta" style="" id="tarjeta">
            ...
            if (resultado[i].foto!='') {
           html+=` <div style="background-image:url('`+urlimagen+`');border-radius: 10px 10px 0px 0px;background-size: cover;" onclick="VisualizarImagen2(\'`+urlimagen+`\')"
            class="card-header align-items-flex-end">
             </div>`;
           }

          html+=`<div class="" style="text-align: right;height: auto;">

          <div class="row">
            <div class="col-100">
            <span style="    text-align: left;
    margin-left: 10px;
    margin-top: 10px;color:#007aff;display: flex;
    justify-content: left;">`+resultado[i].nombreusuario+` | `+resultado[i].fechaformato+`</span>
            </div>
          </div>
          <div class="row">
            <div class="col-80">
    ...
    display: flex;">`+resultado[i].comentario+`</span>
            </div>

            <div class="col-20">`;

            if (resultado[i].sepuedeeliminar==1) {
                html+=`<span onclick="Eliminarimagencitacomentario(`+resultado[i].idimagencitacomentario+`)"  class="material-icons-outlined " style="margin-right: 10px;margin-top: 10px;font-size: 30px;">delete</span>`;   
              }
          html+=`  </div>
   ...
   `;
     ...
     $(".listadoimagenescitacomentario").html(html);
...
function VisualizarImagen2(foto) {
   ...
   myPhotoBrowserPopupDark = app.photoBrowser.create({
    ...
    $(".right").append('<div class="iconocerrar2"></div>');
...
function Eliminarimagencitacomentario(idimagenescita) {
    ...
    var aviso='¿Seguro que desea eliminar la imagen?';
                 ...
                 <div class="" style="position: absolute;top:1em;width: 100%;">
                        ...
                        `;
                          ...
                          <div class="row margin-bottom " style="padding-top: 1em;    margin-left: 2em;margin-right: 2em;margin-top:20px;">
                            <div class="col-50">
                            <button style="background: #C7AA6A;color:white;" type="button" class="button button-fill color-theme button-large button-raised  cambiarfuente" onclick="EliminacionImagenComentario(`+idimagenescita+`)">Si</button>
                            </div>
...
function EliminacionImagenComentario(idimagenescita) {
