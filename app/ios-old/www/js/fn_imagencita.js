 ...
 if (resultado.length>0) {
  for (var i = 0; i < resultado.length; i++) {
   ...
   <div class="tarjeta" style="" id="tarjeta">
    ...
    <span onclick="EliminarImagencita(`+resultado[i].idimagencita+`)"  class="material-icons-outlined " style="margin-right: 10px;margin-top: 10px;font-size: 30px;">delete</span>
       </div>
        </div>
        </div>
                 ...
                 <div class="" style="position: absolute;top:1em;width: 100%;">
                        ...
                        `;
                          ...
                          <div class="row margin-bottom " style="padding-top: 1em;    margin-left: 2em;margin-right: 2em;margin-top:20px;">
                            <div class="col-50">
                            <button style="background: #C7AA6A;color:white;" type="button" class="button button-fill color-theme button-large button-raised  cambiarfuente" onclick="EliminacionImagen(`+idimagenescita+`)">Si</button>
                            </div>
...
function EliminacionImagen(idimagenescita) {
