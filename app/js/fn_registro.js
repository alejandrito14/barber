...
function ValidarCelular() {
	...
	if (inputleido==1) {
		...
		AbrirModalPregunta(telefono,inputleido,telefono1);
...
function AbrirModalPregunta(telefono,inputleido,telefono1) {
		localStorage.setItem('celular',telefono1);
	   var html="";
        html+=`
                 ...
                 <div class="" style="position: absolute;top:1em;width: 100%;">
                        ...
                        `;
                          ...
                          <div class="row margin-bottom " style="padding-top: 1em;margin-left: 2em;margin-right: 2em;">
                            <div class="col-50">
                            <button style="background: #C7AA6A;color:white;" type="button" class="button button-fill color-theme button-large button-raised  cambiarfuente cambiarfuente2" onclick="Elegirsmswhatsap('`+telefono+`',`+inputleido+`)">Si</button>
                            </div>
...
function Elegirsmswhatsap(telefono,inputleido) {
	dynamicSheet1.close();
	   var html="";
        html+=`

        <p class="`+estiloparrafo+`" style="margin-top: 60px;">¿Cómo deseas recibir el token de verificación?</p>
                 ...
                 <div class="" style="position: absolute;top:1em;width: 100%;">
                        ...
                        `;
                          ...
                          <div class="row margin-bottom " style="padding-top: 1em;margin-left: 2em;margin-right: 2em;">
                            ...
                            <div class="col-50">
                            <button style="background: white;color:black;" type="button" class="button button-fill color-theme button-large button-raised  cambiarfuente cambiarfuente2" onclick="EjecutarValidacion('`+telefono+`',`+inputleido+`,2)">WhatsApp</button>
                            </div>

                            <div class="col-50">
                            <button style="background: #C7AA6A;color:white;" type="button" class="button button-fill color-theme button-large button-raised  cambiarfuente cambiarfuente2" onclick="EjecutarValidacion('`+telefono+`',`+inputleido+`,1)">SMS</button>
                            </div>
                          </div>
...
function EjecutarValidacion(telefono,inputleido,eleccionusuario) {
		var id_user=localStorage.getItem('id_user');
	
		var sistema=localStorage.getItem('SO');
		var uuid=localStorage.getItem('UUID');
		var datos="telefono="+telefono+"&sistema="+sistema+"&uuid="+uuid+"&inputleido="+inputleido+"&iduser="+id_user+"&eleccionusuario="+eleccionusuario;
...
function AbriModalAcceder() {
  ...
  var parrafo="<p class='cambiarfuente "+estiloparrafo+"'>El número de celular que ingresaste ya existe</p>";
   parrafo+="<p class='cambiarfuente "+estiloparrafo+"'>¿Deseas acceder?</p>";
...
function ReenvioTokenCel() {
	...
	Elegirsmswhatsap3(telefono);
}

function EjecutarReeenvio(telefono,eleccionelegida) {
		var sistema=localStorage.getItem('SO');
		var uuid=localStorage.getItem('UUID');
		var telefono=localStorage.getItem('celular');
		var datos="telefono="+telefono+"&sistema="+sistema+"&uuid="+uuid+"&eleccionusuario="+eleccionelegida;
		...
		success: function(datos){
			...
			if (completado==1) {
				...
				dynamicSheet1.close();
				var aviso="Token de verificacion reenviado";
...
function Elegirsmswhatsap3(usuario) {
                 ...
                 <div class="" style="position: absolute;top:1em;width: 100%;">
                        ...
                        `;
                          ...
                          <div class="row margin-bottom " style="padding-top: 1em;margin-left: 2em;margin-right: 2em;">
                            ...
                            <div class="col-50">
                            <button style="background: white;color:black;" type="button" class="button button-fill color-theme button-large button-raised  cambiarfuente cambiarfuente2" onclick="EjecutarReeenvio('`+usuario+`',2)">WhatsApp</button>
                            </div>

                            <div class="col-50">
                            <button style="background: #C7AA6A;color:white;" type="button" class="button button-fill color-theme button-large button-raised  cambiarfuente cambiarfuente2" onclick="EjecutarReeenvio('`+usuario+`',1)">SMS</button>
                            </div>
                          </div>
