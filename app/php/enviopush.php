...
define('API_ACCESS_KEY', 'AAAAWde0tiY:APA91bFKb9kYErB8MoXTyEiUNfYNi4VpPLBKte6PXkYjke0ygYMmGdhYj22i_0nkji4erMtBGfkHzGfde47o1IVRTvte4Fg7RISglYexXfE3H2zcYWksrwwAOCEU6gcaLCGqNmv_DgWr'); // Replace YOUR FIREBASE CLOUD MESSAGING API KEY with your Firebase Cloud Messaging server Key
...
$titulo = htmlspecialchars($title,ENT_COMPAT);
$mensaje = htmlspecialchars($message,ENT_COMPAT);
$postlink = htmlspecialchars($postlink,ENT_COMPAT);
    ...
    $tokenList=$listatokens;
     ...
     $notification = [
        ...
        $extraNotificationData = ["notification_foreground" => "true", "navigation" => $navpage, "idcliente" => $idcliente,"valor"=>$valor];
