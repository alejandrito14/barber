...
<body>
    <div class="ticket centrado">
        <h3 style="font-size: 14px">' . $f->imprimir_cadena_utf8($notaremision[0]->titulo). '</h3>
        <h3 style="font-size: 10px">RFC:<span class="negritas" style="font-size: 10px"> ' . $notaremision[0]->rfcsucursal . '</span></h3>
        <h3 style="font-size: 10px">'.$f->imprimir_cadena_utf8('DIRECCIÓN').':<span class="negritas" style="font-size: 10px"> ' . $f->imprimir_cadena_utf8($notaremision[0]->direccion ). '</span></h3>
