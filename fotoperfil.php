	...
	foreach($_FILES as $key) 
	  {
		if($key['error'] == UPLOAD_ERR_OK ){//Verificamos si se subio correctamente
			...
			$nombre = $f->conver_especial($id."_".$key['name']);//Obtenemos el nombre del archivo
			...
			$nombre = $nombre_img[0];
		  	...
		  	move_uploaded_file($temporal,"upload/perfil/".$nombre); //Movemos el archivo temporal a la ruta especificada
