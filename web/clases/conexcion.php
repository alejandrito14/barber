...
{ 
	...
	public function m_error($err)
	 ...
	 /*public function ObtenerLlavesForaneas($tabla)
	 {
	 	$sql="SELECT * FROM INFORMATION_SCHEMA.KEY_COLUMN_USAGE WHERE CONSTRAINT_SCHEMA="$this->db" AND TABLE_NAME="'$tabla'" and CONSTRAINT_NAME like '%fk%'";
