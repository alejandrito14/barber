...
<html lang="en">
    ...
    <body id="page-top">
        <!-- Navigation-->
        <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav" style="display: none;">
            <div class="container">
    ...
    justify-content: center;" >
        ...
        <!-- About-->
        <section class="page-section" style="display: none;" id="about">
            <div class="container">
                <div class="text-center">
        ...
        <!-- Team-->
        <section class="page-section bg-light" id="team" style="display: none;">
            <div class="container">
                <div class="text-center">
