...
if(!isset($_GET['idcategoria'])){
	...
	$depende = $f->imprimir_cadena_utf8($result_presentacion_row['iddepende']);
		...
		<div class="card-body">
			...
			<div style="float: right;">
				...
				<?php
					...
					$bt->funcion = "var resp=MM_validateForm('v_nombre','','R'); if(resp==1){ GuardarCategoriaspaquete('f_categoria','catalogos/categoriapaquete/vi_categoriaspaquete.php','main','$idmenumodulo');}";
				...
				<button type="button" onClick="aparecermodulos('catalogos/categoriapaquete/vi_categoriaspaquete.php?idmenumodulo=<?php echo $idmenumodulo;?>','main');" class="btn btn-primary" style="float: right; margin-right: 10px;"><i class="mdi mdi-arrow-left-box"></i> LISTADO DE CATEGORÍAS </button>
...
<p style="text-align: center;">Dimensiones de la imagen Ancho:1280px Alto:852px</p>
							...
							<div class="form-group m-t-20" style="">
								...
								<select  class="form-control" id="v_depende" name="v_depende" >
									...
									do{
									?>
									<option value="<?php echo ($categorias_row['idcategoriapaquete']);?>" <?php if($categorias_row['idcategoriapaquete']==$depende){ echo ("selected");}?>><?php echo ($categorias_row['nombre']);?></option>
