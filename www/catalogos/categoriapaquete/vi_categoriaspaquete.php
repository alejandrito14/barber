	...
	<div class="card-body">
		...
		<div style="float:right;">
			...
			<?php
				...
				$bt->funcion = "aparecermodulos('catalogos/categoriapaquete/fa_categoriaspaquete.php?idmenumodulo=$idmenumodulo','main');";
				$bt->estilos = "float: right; margin-right:10px;";
				$bt->permiso = $permisos;
				$bt->tipo = 5;
				$bt->title="NUEVA CATEGORIA";
...
<script type="text/javascript">
	Buscar_categoriaspaquete(<?php echo $idmenumodulo; ?>);
</script>
