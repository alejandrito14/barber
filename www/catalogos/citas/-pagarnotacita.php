...
<div class="row" style="padding-right: 30px;margin-bottom: 1em;">
    ...
    <div class="col-md-12">
      <button type="button" class="btn  btn-success btn-lg btn-block" onclick="AbrirModalMetodo()">AGREGAR OTRO MÉTODO</button>
    </div>
  </div>
...
<div class="modal fade" id="modal-formsmetodo" tabindex="-1" role="dialog" style="overflow-y: scroll;" >
    <div class="modal-dialog modal-lg" id="largomodalmetodo">
        <div class="modal-content" id="">
            <div class="modal-header">
                <h5 class="modal-title" id="titulo-modal-forms">Agregar otro método</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
...
function AbrirModalMetodo() {
  ...
  var contar=$(".titulometodopago").length;

  contar=contar+1;

  html+=`
      <div class="col-md-12" style="" id="titulometodopago_`+contar+`">
      <!-- <select name="" id="tipopago" class="form-control" onchange="CargarOpcionesTipopago()" style="padding-left: 30px;">
        <option value="0">SELECCIONAR MÉTODO DE PAGO</option>
      </select> -->
      <p>SELECCIONAR MÉTODO DE PAGO</p>
      <div class="divtipopago  btn-group-toggle litipodepago_`+contar+`">
  ...
  <div class="row" style="padding-right: 30px;margin-top: 1em">
    ...
    <div class="col-md-12 divdigitos_`+elemento+`" style="display: none;" >

      <div class="form-group">
        <label for="">DÍGITOS DE LA TARJETA</label>

        <input type="text" class="form-control" id="txtdigitostarjeta_`+elemento+`" onkeyup="VerficarFormulariocompleto()">
    </div>
    </div>
      ...
      <div class="form-group">
        <label for="">OPCIONES DE TARJETA</label>
          ...
          <div class="btn-group-toggle ">
                <label class="btn btn_colorgray2 btntipo" id="catetipo_1_`+elemento+`">
      <input type="checkbox" id="catetipo_1_`+elemento+`" class="catechecktipo`+elemento+`" onchange="SeleccionarOpciontarjeta(1,`+elemento+`)" value="0"> 
        DÉBITO</label>

          <label class="btn btn_colorgray2 btntipo" id="catetipo_2`+elemento+`">
      <input type="checkbox" id="catetipo_2_`+elemento+`" class="catechecktipo1" onchange="SeleccionarOpciontarjeta(2,`+elemento+`)" value="0"> 
        CRÉDITO</label>
  ...
  <div class="">
     ...
     <div class="divtransferencia_`+elemento+`" style="display: none;">
      <div  >
       ...
       <div id="campomonto_`+elemento+`" style="display: none;">
    <div class="subdivisiones" style="margin-top: 1.5em;width: 12em!important;" >
      <span style="margin-top: .5em;margin-left: .5em;">¿Con cuanto pagas?</span>
    </div>
    ...
    <div class="row" style="">
     <div  style="" class="col-md-12">
            ...
            <div class="label-radio item-content">
              ...
              <div class="item-inner">
                ...
                <div class="">
                  ...
                  <input type="number" name="montovisual" class="form-control" id="montovisual_`+elemento+`" style="font-size: 18px;float: left;padding-right: 30px;" placeholder="$0.00"  />
                  <input type="number" name="montocliente" id="montocliente`+elemento+`"  style="font-size: 18px;float: left;width: 60%;    margin-left: 1.2em;display: none;" placeholder="$0.00"   />
      ...
      <div class="row" style="margin-top: 5px;">
          <div class="col-md-12">
            <label class="">Cambio $<span id="cambio_`+elemento+`">0.00</span>
            </label>
          </div>
    ...
    <div class=" row">
              ...
              <div class="">
                  <div class="row no-gap" style="text-align: center;"> 
                   <img src="" id="imagencomprobante_`+elemento+`" width="60" />
                  </div>
                </div>
        ...
        <div class=" divtarjetas" >
          <div class="" id="divlistadotarjetas_`+elemento+`">
    ...
    <div class="" id="divagregartarjeta_`+elemento+`" style="display: none;">
  ...
  $("#contenedor-modal-formsmetodo").html(html);
  ObtenerTipodepagosCompletar2(0,elemento);
}
...
function PintarTipoPagos3(respuesta,idtipodepago,elemento) {
  ...
  if (respuesta.length>0) {
      ...
      html+=`
      <label class="btn btn_colorgray2 btntipodepago " id="catebtntipodepago_`+respuesta[i].idtipodepago+`_`+elemento+`">
...
function CargarOpcionesTipopago4(idtipopago,elemento){
  ...
  if (idtipopago>0) {
    ...
    url:'catalogos/pagos/Cargartipopago.php', //Url a donde la enviaremos
      ...
      HabilitarOpcionespago2(resultado.idtipodepago,resultado.habilitarfoto,resultado.constripe,resultado.habilitarcampomonto,resultado.habilitarcampomontofactura,resultado.habilitarcatalogobanco,resultado.habilitarcampodigitos,resultado.habilitaropciontarjeta,elemento);
...
function HabilitarOpcionespago2(idtipodepago,foto,stripe,habilitarcampo,habilitarcampomontofactura,habilitarcatalogobanco,habilitardigitos,habilitaropciontarjeta,elemento) {
...
function PintarBancos2(respuesta,elemento) {
  ...
  if (respuesta.length>0) {
    for (var i = 0; i <respuesta.length; i++) {
      html+=`<label class="btn btn_colorgray2 btnbancos" id="catebtnbanco_`+respuesta[i].idbancos+`_`+elemento+`">
