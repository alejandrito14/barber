...
<script>
  var llaveelemento='<?php echo $llaveelemento ?>';
...
function PintarProductosSeleccionados(arraypaqueteseleccionado) {
	...
	if (arraypaqueteseleccionado.length>0) {
		...
		<div class="col-md-12" style="padding:0;margin:0;">
			<button type="button" class="btn  btn-success btn-lg btn-block" style="width:100%;margin-top:10px;" id="btstep1" onclick="showContinuar('`+llaveelemento+`')" >CONTINUAR</button>
			<div>
		</div>
...
function showContinuar(llaveelemento) {
  var dividir=llaveelemento.split('_');
  var posicioni=dividir[1];
  var posicionj=dividir[2];
