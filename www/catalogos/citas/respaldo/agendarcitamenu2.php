...
function PintarProductosSeleccionados(arraypaqueteseleccionado) {
	...
	if (arraypaqueteseleccionado.length>0) {
		...
		<div class="col-md-12" style="padding:0;margin:0;">
			<button type="button" class="btn  btn-success btn-lg btn-block" style="width:100%;margin-top:10px;" id="btstep1" onclick="ContinuarGuardar()" >CONTINUAR</button>
			<div>
		</div>
...
function ContinuarGuardar() {
  ...
  var datos="idnotapago="+idnotapago+"&valoredicion=0"+"&elementos="+JSON.stringify(arraypaqueteseleccionado);
