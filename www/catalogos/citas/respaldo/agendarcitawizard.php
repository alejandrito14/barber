...
if (isset($_POST['horainicialselect'])) {
  ...
  if (!empty($_POST['horainicialselect'])) {
    # code...
...
<div class="wizard-step" id="step5" style="display:none;">
  ...
  <div class="card" id="home" role="tabpanel">
     <div class="card-header" style="margin-top: 1em;    margin-bottom: 1em;">
      <h5>EL TIEMPO DEL SERVICIO <span id="colorcarserviciotiempo"></span>¿DESEA CAMBIARLO? </h5>
    </div>
...
function GuardarCitaP() {
 ...
 var datos="idusuario="+idusuarioagenda+"&idsucursal="+idsucursal+"&idpaquete="+idpaqueteseleccionado+"&fecha="+fechaseleccionada;
  datos+="&horario="+horarioseleccionado+"&idespecialista="+idespecialistaseleccionado+"&costo="+costopaquete+"&cantidad=1"+"&valorseleccionado="+valorseleccionado+"&idcortesiaseleccionado="+idcortesiaseleccionado;
  ...
  $.ajax({
     ...
     success:function(msj){
       ...
       <p>Por favor realizar el pago para que la cita quede agendada</p>
