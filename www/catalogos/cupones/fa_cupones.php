						...
						<?php      
						    	...
						    	if ($contar>0) {
							    	 do {
						    			...
						    			?>
									    <input  type="checkbox" value="" class="form-check-input chkpaquete_<?php echo $idcupon;?>" id="inputpaq_<?php echo $a_paquete['idpaquete']?>_<?php echo $a_sucursal['idsucursal'];?>" <?php echo $valor; ?>>
						...
						?>
						    	<div class="form-check suc_"  id="suc_<?php echo $a_sucursal['idsucursal'];?>">
						    	    <?php 	
						    			$valor="";
						    		?>
									  <input  type="checkbox" value="" class="form-check-input chksucursal_<?php echo $idcupon;?>" id="inputsuc_<?php echo $a_sucursal['idsucursal']?>" <?php echo $valor; ?>>
