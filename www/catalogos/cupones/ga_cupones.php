...
try
{
	...
	$cup->montocompra="0";
	if ($_POST['v_montocompra']!='') {
	$cup->montocompra = $_POST['v_montocompra'];
	}

	$cup->cantidadcompra="0";
	if ($_POST['v_cantidadcompra']!='') {
