...
if(!isset($_GET['idpaquete'])){
 ...
 $costo=$result_presentacion_row['costo'];
						...
						<div class="card">
							...
							<div class="form-group" >
							 <div id="verprecio" style="display: none;"><label>PRECIO $:</label><span id="precioprincipal"></span> </div>
								...
								<div class="form-group m-t-20" id="costo" style="">
								COSTO $:
							
								<input type="number" name="txtcosto" class="form-control" id="txtcosto"  value="<?php echo $costo?>"/>
