...
$venderproductos=0;
if (isset($_GET['venderproductos'])) {
		$venderproductos=$_GET['venderproductos'];
}
...
<div class="modal" id="modalespera" tabindex="-1" role="dialog" style="z-index: 2090;">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title"></h5>
...
venderproductos='<?php echo $venderproductos ?>';

if (clienteseleccionado>0) {

	CrearSesionUsuario_puntoventa(clienteseleccionado);
...
ObtenerSucursales_puntoventa(idsucursalseleccionada); 
...
promesa.then(function(resultado) {
	...
	if (resultado.length>0) {
		 ...
		 ObtenerCategoriasPrincipales_puntoventa(venderproductos);
...
function AgregarCarrito() {
    ...
    success: function(datos){
    	...
    	if (carrito.length>0) {
    		...
    		PintarElementos_puntoventa(carrito);
    		$("#searchInput").val('');
...
function SeleccionarPaquete(idpaquete) {
	...
	var dataelemento=elemento.data('recurso');
	 ...
	 PintarElementos_puntoventa(arraypaquetes);

}


function PintarElementos_puntoventa(arraycarrito) {
	var html="";
    ...
    html+=  `</td>
      ...
      <button type="button" onclick="BorrarPaqueteArray_puntoventa(`+arraycarrito[i].idcarrito+`)" class="btn btn_rojo" style="" title="BORRAR">
...
function BorrarPaqueteArray_puntoventa(idcarrito) {
