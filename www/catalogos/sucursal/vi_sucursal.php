	...
	<div class="card-body">
		...
		<div style="float:right;">
			...
			<?php
				...
				$bt->funcion = "aparecermodulos('catalogos/sucursal/fa_sucursales.php?idmenumodulo=$idmenumodulo','main');";
	...
	<div class="card-body">
		<div class="table-responsive" id="contenedor_empresas">
			...
			<tr>
				  ...
				  <td style="text-align: center;"><?php echo $f->imprimir_cadena_utf8($l_empresas_row['idsucursal']); ?></td>
			    <td style="text-align: center;"><?php echo $f->imprimir_cadena_utf8($l_empresas_row['titulo']); ?></td>
				...
				<td style="text-align: center; font-size: 15px;">
					...
					<?php
						...
						$bt->funcion = "aparecermodulos('catalogos/sucursal/fa_sucursales.php?idsucursales=".$l_empresas_row['idsucursal']."&idmenumodulo=$idmenumodulo','main')";
						$bt->estilos = "";
						$bt->permiso = $permisos;
						$bt->title="EDITAR";
					...
					<?php
						...
						$bt->funcion = "BorrarSucursal('".$l_empresas_row['idsucursal']."','".$idmenumodulo."')";
						$bt->estilos = "";
						$bt->permiso = $permisos;
						$bt->tipo = 3;
						$bt->title="BORRAR";
					...
					<button class="btn btn-primary" type="button" onclick="Subirimagensucursal(<?php echo $l_empresas_row['idsucursal']; ?>)" title="SUBIR IMAGENES">
