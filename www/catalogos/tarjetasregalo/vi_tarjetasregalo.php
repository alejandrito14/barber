...
<div class="card">
  <div class="card-body">
    <h5 class="card-title" style="float: left;">LISTADO DE TARJETAS DE REGALO</h5>
    ...
    <div style="float:right;">
      ...
      <?php
        ...
        $bt->funcion = "aparecermodulos('catalogos/tarjetasregalo/fa_tarjetasregalo.php?idmenumodulo=$idmenumodulo','main');";
          ...
          if($l_Tarjetaregalo_num== 0){
            ...
            do
            {
              ...
              <td style="text-align: center; font-size: 15px;">
                  ...
                  $bt->funcion = "BorrarDatos('".$l_Tarjetaregalo_row['idtarjetaregalo']."','idtarjetaregalo','tarjetaregalo','n','catalogos/tarjetaregalo/vi_tarjetaregalo.php','main','$idmenumodulo')";
                  $bt->estilos = "";
                  $bt->permiso = $permisos;
                  $bt->tipo = 3;
                  $bt->title="BORRAR";
