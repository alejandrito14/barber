...
if ($this->idespecialista==4 && $horainiciale=='13:00') {
	...
	{
		$sql="SELECT TABLA1.*,paquetes.nombrepaquete,paquetes.intervaloservicio from (SELECT citas.*,CONCAT(usuarios.nombre)as nombrecliente,notapago_descripcion.idnotapago
			FROM citas
	...
	public function ObtenerEspecialistasTVisibledashboard()
	{
		$sql = "SELECT 
		 ...
		 WHERE usuarios.visibledashboard=1 AND especialista.bloqueo=0 AND sucursal.idsucursal='$this->idsucursal' ORDER BY usuarios.orden asc ";
