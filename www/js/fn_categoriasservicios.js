function Guardarcategoriasservicio(form,regresar,donde,idmenumodulo)
{
	...
	{			
		...
		setTimeout(function(){
				  $.ajax({
					url:'catalogos/categoriasservicios/ga_categoriaservicios.php', //Url a donde la enviaremos
