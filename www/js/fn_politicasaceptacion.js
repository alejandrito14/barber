function GuardarPoliticaaceptacion(form,regresar,donde,idmenumodulo)
{
	...
	{			
		...
		setTimeout(function(){
				  $.ajax({
					url:'catalogos/politicasaceptacion/ga_politicaaceptacion.php', //Url a donde la enviaremos
