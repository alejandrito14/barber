...
function Guardarpublicidad(form,regresar,donde,idmenumodulo)
{
	...
	{			
		...
		setTimeout(function(){
				  $.ajax({
					url:'catalogos/publicidad/ga_publicidad.php', //Url a donde la enviaremos
...
function Borrarpublicidad(idpublicidad,campo,tabla,valor,regresar,donde,idmenumodulo) {
	
var datos='idpublicidad='+idpublicidad;
	$.ajax({
		url:'catalogos/publicidads/borrarpublicidad.php', //Url a donde la enviaremos
	  type:'POST', //Metodo que usaremos
	  data: datos, //Le pasamos el objeto que creamos con los archivos
	  error:function(XMLHttpRequest, textStatus, errorThrown){
			var error;
