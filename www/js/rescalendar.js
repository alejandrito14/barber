    ...
    $.fn.rescalendar = function( options ) {
        ...
        function addTdClickEvent(targetObj){
            ...
            day_cell.on('click', function(e){
                ...
                var cellpaquete = targetObj.attr('id');
                var dividir=cellpaquete.split('_');
                cellpaquete=dividir[1]+'_'+dividir[2]+'_'+dividir[3];

                console.log(cellpaquete);
                 //alert('paquete'+cellpaquete);

                 ObtenerHorariosStep2(cellDate,cellpaquete);
            });
                ...
                return [
                    ...
                    '<div class="rescalendar ' , id , '_wrapper">',
                        ...
                        '<div class="rescalendar_controls">',
                            ...
                            '<button type="button" style="float:left;margin-right: 15px;" class="btn move_to_last_month"> << </button>',
                            '<button type="button" style="float:left;margin-right: 15px;" class="btn move_to_yesterday"> < </button>',

                            '<input class="refDate form-control" style="float:left;" type="text" value="' + refDate + '" />',
                            
                            '<button type="button" style="float:left;margin-left: 15px;" class="btn move_to_tomorrow"> > </button>',
                            '<button type="button" style="float:left;margin-left: 15px;" class="btn move_to_next_month"> >> </button>',

                            '<br>',
                            '<button type="button" class="btn move_to_today"> ' + settings.lang.today + ' </button>',
