...
*/                  if (count($consultarsiestaocupado)>0) {
    ...
    //print_r($ObtenerProductosnotasincita);die();
                      ...
                      for($k=0;$k<count($tipospago);$k++){
                       ...
                       if (trim($metodospago[$i]['tipopago'])==trim($tipospago[$k]->tipo)) {
                        ...
                        <td>
                         ...
                         $tipospago[$k]->montoacumulado=$tipospago[$k]->montoacumulado+$cita[0]['monto'];
                      ...
                      for($k=0;$k<count($tipospago);$k++){
                       ...
                       if (trim($metodospago[$i]['tipopago'])==trim($tipospago[$k]->tipo)) {
                        ...
                        <td>
                         ...
                         $tipospago[$k]->montoacumulado=$tipospago[$k]->montoacumulado+$productos[$j]->monto;
